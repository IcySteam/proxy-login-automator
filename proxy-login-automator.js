      ...
      for (var i = 0; i < buf_len; i++) {
        ...
        if (buf[i] === LF) {
          ...
          if (parser.__is_headers_complete) {
            ...
            //reusing the proxy connection / HTTP Keep-Alive will give you the same session / IP address even if you supply a different session ID when connecting again to the same MarsProxies server
